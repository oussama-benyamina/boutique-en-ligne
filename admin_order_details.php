        ...
        <div class="order-container">
            ...
            <div class="order-section">
                ...
                <div class="info-grid">
                    ...
                    <p><strong>Delivery Status:</strong> <?= htmlspecialchars($order['status']) ?></p>
                    ...
                    <?php if (!empty($order['admin_notes'])): ?>
                        <p><strong>Admin Notes:</strong> <?= nl2br(htmlspecialchars($order['admin_notes'])) ?></p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="back-button">
                <a href="order_management.php" class="boxed-btn">Back to Order Management</a>
            </div>
        </div>
    </div>
